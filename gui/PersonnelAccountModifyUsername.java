...
public class PersonnelAccountModifyUsername extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
	private static String fullName, username, id;
	private static String indicator = "USERNAME";
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelAccountModifyUsername frame = new PersonnelAccountModifyUsername(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelAccountModifyUsername(String fullName, String username, String id) {
		...
		JLabel lblNewLabel = new JLabel("Enter your new username:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelAccountModifyUsername.this.dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.isEmpty()) {
					JOptionPane.showMessageDialog(btnNewButton_1, "Please enter your new username!");
				} else {
					Personnel pnl = new Personnel();
					int x = pnl.validatingUsername(valueSearch);
					if(x == 1) {
						JOptionPane.showMessageDialog(btnNewButton_1, "Username has been used!");
					} else {
						pnl.modify(username, valueSearch, indicator);
						Record dateTime = new Record();
						dateTime.setCurrentdate();
						dateTime.setAction("MODIFYING USERNAME");
