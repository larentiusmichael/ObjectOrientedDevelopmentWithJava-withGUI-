...
public class PeopleAccountModifyPassword1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PeopleAccountModifyPassword1 frame = new PeopleAccountModifyPassword1(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PeopleAccountModifyPassword1(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PeopleAccountModifyPassword1.this.dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.isEmpty()) {
					...
					int x = ppl.validatingPassword(valueSearch);
					if (x == 1) {
						new PeopleAccountModifyPassword2(fullName, username, id).setVisible(true);
						PeopleAccountModifyPassword1.this.dispose();
					} else {
