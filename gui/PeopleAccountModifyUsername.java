...
public class PeopleAccountModifyUsername extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PeopleAccountModifyUsername frame = new PeopleAccountModifyUsername(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PeopleAccountModifyUsername(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PeopleAccountModifyUsername.this.dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.isEmpty()) {
					...
					int x = ppl.validatingUsername(valueSearch);
					if(x == 1) {
