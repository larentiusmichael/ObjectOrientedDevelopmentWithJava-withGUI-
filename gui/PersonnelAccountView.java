...
public class PersonnelAccountView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelAccountView frame = new PersonnelAccountView(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelAccountView(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelAccountView.this.dispose();
			}
		});
