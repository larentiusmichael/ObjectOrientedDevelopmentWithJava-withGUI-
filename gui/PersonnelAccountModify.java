...
public class PersonnelAccountModify extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelAccountModify frame = new PersonnelAccountModify(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelAccountModify(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new PersonnelAccountModifyUsername(fullName, username, id).setVisible(true);
				PersonnelAccountModify.this.dispose();
			}
		});
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new PersonnelAccountModifyPassword1(fullName, username, id).setVisible(true);
				PersonnelAccountModify.this.dispose();
			}
		});
