...
public class PersonnelVaccinationAppointmentView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelVaccinationAppointmentView frame = new PersonnelVaccinationAppointmentView(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelVaccinationAppointmentView(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelVaccinationAppointmentView.this.dispose();
			}
		});
