...
public class PersonnelVaccineSupplyModify2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelVaccineSupplyModify2 frame = new PersonnelVaccineSupplyModify2(fullName, username, id, value);
	 ...
	 * Create the frame.
	 */
	public PersonnelVaccineSupplyModify2(String fullName, String username, String id, String value) {
		...
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Producing Country");
		...
		JRadioButton rdbtnNewRadioButton_2 = new JRadioButton("Dose");
		...
		JRadioButton rdbtnNewRadioButton_5 = new JRadioButton("Amount");
		...
		JRadioButton rdbtnNewRadioButton_6 = new JRadioButton("City");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelVaccineSupplyModify2.this.dispose();
			}
		});
