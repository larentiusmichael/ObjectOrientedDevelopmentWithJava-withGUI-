...
public class PersonnelVaccineSupplyRemove extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelVaccineSupplyRemove frame = new PersonnelVaccineSupplyRemove(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelVaccineSupplyRemove(String fullName, String username, String id) {
		...
		JLabel lblNewLabel = new JLabel("Enter Vaccine Supply ID whose details will be removed:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelVaccineSupplyRemove.this.dispose();
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.isEmpty()) {
					...
					if(result == 0) {
						...
						vcn.remove(valueSearch);
						Record dateTime = new Record();
						dateTime.setCurrentdate();
						dateTime.setAction("REMOVING VACCINE");
