...
public class PersonnelUserPersonnelView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelUserPersonnelView frame = new PersonnelUserPersonnelView(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelUserPersonnelView(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelUserPersonnelView.this.dispose();
			}
		});
