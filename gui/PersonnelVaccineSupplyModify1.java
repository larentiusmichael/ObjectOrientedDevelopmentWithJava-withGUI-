...
public class PersonnelVaccineSupplyModify1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelVaccineSupplyModify1 frame = new PersonnelVaccineSupplyModify1(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelVaccineSupplyModify1(String fullName, String username, String id) {
		...
		JLabel lblNewLabel = new JLabel("Enter Vaccine Supply ID whose details will be modified:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelVaccineSupplyModify1.this.dispose();
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(valueSearch.isEmpty()) {
					...
					if(result == 0) {
						...
						new PersonnelVaccineSupplyModify2(fullName, username, id, valueSearch).setVisible(true);
						PersonnelVaccineSupplyModify1.this.dispose();
					}
				}
			}
