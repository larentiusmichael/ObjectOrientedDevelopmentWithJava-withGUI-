...
public class PeopleAccount extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PeopleAccount frame = new PeopleAccount(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PeopleAccount(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new PeopleAccountView(fullName, username, id).setVisible(true);
				PeopleAccount.this.dispose();
			}
		});
