...
public class PersonnelUserPeopleSearch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelUserPeopleSearch frame = new PersonnelUserPeopleSearch(fullName, username, id, type, value, indicator);
	 ...
	 * Create the frame.
	 */
	public PersonnelUserPeopleSearch(String fullName, String username, String id, String type, String value, String indicator) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelUserPeopleSearch.this.dispose();
			}
		});
