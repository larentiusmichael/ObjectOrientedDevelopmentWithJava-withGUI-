...
public class PersonnelUserPeopleView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonnelUserPeopleView frame = new PersonnelUserPeopleView(fullName, username, id);
	 ...
	 * Create the frame.
	 */
	public PersonnelUserPeopleView(String fullName, String username, String id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PersonnelUserPeopleView.this.dispose();
			}
		});
